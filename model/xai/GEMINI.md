...
- **Language:** Go (Golang)
- **Style:** Adhere to standard Go formatting (`gofmt`, `gofumpt`, `goimports-rereviser -project-name=github.com/zchee/tumix/model/xai -use-cache -cache-fast-skip -format -rm-unused -set-alias ./...`) and idioms.
