module github.com/zchee/tumix/model/xai/examples/chat_structured_tools

go 1.25

replace github.com/zchee/tumix/model/xai => ../../

require github.com/zchee/tumix/model/xai v0.0.0-00010101000000-000000000000
