module github.com/zchee/tumix/gollm/xai/examples

go 1.25

replace github.com/zchee/tumix/gollm/xai => ../
...
require (
	...
	github.com/invopop/jsonschema v0.0.0-00010101000000-000000000000 // indirect
